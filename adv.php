...
<body>
	...
	<form action=<?php print("'adv.php?ID=$_GET[ID]'"); ?> method='post' name='t'>
		<fieldset>
			...
			Date:<input type='text' name='date' value='ALL' size='10'> <input type='submit' name='print' value='Print Time Table' title='Print a one-day schedule beginning at the given date, or ALL for all dates.'><br>
